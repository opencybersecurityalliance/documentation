...
\f0\fs24 \cf0 Use Cases for Open Cybersecurity Alliance\
\
October 30, 2020\
\
...
# Objective:\
\
Author three use cases for OCA\'92s use that three use cases that would occur in the SOC and will benefit\
from the OCA fabric of projects.\
\
# What\'92s in a good use case?\
\
A good use case describes how users perform tasks. It features the user\'92s point of view and describes\
...
\
Of note \'96 but very much going on in the background - as Bob turns on his computer, Bob\'92s endpoint\
...
background, ensuring that Bob\'92s computer is protected from the latest known malware attacks. The\
software also checks in with Bob\'92s corporate network asking a similar question, \'93Are there any new\
blocks we need to know about?\'94 the software asks the corporate library of rules. No new rules are\
...
\'93from\'94 name Says Alice, but it is not displaying at it typically would. He clicks anyways, as he is looking\
forward to the next step in a project.\
\
Bob opens the e-mail to see \'93I found this link that I think will help us with our project, talk soon\'94 \'96\
followed by a URL.\
\
Of course Bob clicks the link, and this is what we call a phishing \'96 or in the case of a specific user, a\
focused \'93spear phishing\'94 attack.\
\
The web site Bob accesses contains a zero-day cyber vulnerability. Bob did not catch it, his e-mail\
system\'92s filter did not, and now Bob\'92s endpoint software has to take over.\
\
The link that Bob clicked opened up a few interesting tidbits, but it did not seem very apropos to Bob\
and Alice\'92s project. He ignored the rest of the site, realizing \'96 too late \'96 that this sounded like one of\
those examples from his security awareness training. \'93I probably should not have clicked that,\'94 Bob\
thought. He looked again at the tempting e-mail and saw that while it had Alice\'92s first name, it did not\
include a last name. And he hovered his mouse over the URL and realized, \'93...not a good site... uhoh.\'94\
\
Bob hasn\'92t seen anything else strange, he only clicked a lick and realized quickly that it was off topic \'96 he\
closed the screen so fast, at this point Bob\'92s fears dwell and he does about his coffee \'96 and his day.\
\
In the background, however, the damage was done in a split second. Bob\'92s computer saw Bob click a link\
\
- he initiated it, and Bob\'92s computer\'92s policies allow him to install software. The software installed itself\
and after setting a timer to \'93go off\'94 in 4 hours, the bad program went dormant.\
\
Malware was installed immediately as Bob clicked the URL \'96 it all happened as the web page loaded.\
\
Bob\'92s endpoint protection software scanned the new program that was downloaded in the background\
\
- the software scans all files coming and going on Bob\'92s computer.\
\
...
\
\
Many people in Bob\'92s company are business and mission focused \'96 they are not savvy IT people.\
Because alerts have created a lot of extra calls and support costs, this security event \'96 unknown\
software \'96 does not pop up on Bob\'92s computer.\
\
...
on Bob\'92s computer, and that the software does not meet any known profiles for programs the corporate\
IT team has seen before.\
\
The tier one security analyst confirms a recommendation to quarantine the new file. The security\
operations team and Bob\'92s malware protection module on his endpoint have detected the result of\
Bob\'92s click and the file has been quarantined on Bob\'92s computer. The new file is added to the corporate\
database of bad software. All the endpoints in Bob\'92s company receive this update in their twice-hourly\
poll of the corporate Malware protection system\'92s database. Everyone in Bob\'92s company who has their\
computer on knows within 45 minutes of Bob\'92s login that the file he downloaded is bad. Any new\
...
morning, and he doesn\'92t mention it to Alice.\
\
Bob thinks this is the first time he has caught a cyber attack knows as \'93phishing\'94 on his own, he noticed\
...
corporate IT team.\
\
The Security team sees a new alert in their system monitoring tools. The alert is titled \'93User Reported\
Malware.\'94\
\
The Tier 1 security analyst reviews the new alert and analyses additional data. The Malware \'93catch\'94\
yesterday on Bob\'92s computer and today\'92s, plus some intelligence from sources and from the malware\
...
Directory. Once these two team\'92s initial checklists are completed, the server\'92s build process routes a\
new ticket to the Security Team.\
\
A tier one analyst sees this recurring request in his team\'92s work queue. New Server, Vulnerability Scan\
request.\
\
The Analyst confirms the workflow step, right-clicking on the server\'92s name. He picks a fuill-featured\
vulnerability scan from a context sensitive list in his SOAR tool.\
\
The action creates a job on the vulnerability server.\
\
25 minutes later, the deep scan \'96 with credentials \'96 of the server is completed. A report is returned to\
...
\
A successful scan report is returned to the security team. They clear the system for use and the ticket\'92s\
...
the system name and an admin user name \'96 not Bob\'92s. The administrator is a member of his team who\
will perform the software installation. The scan report seems technical to Bob, he skims it but does not\
really understand it.\
\
\
Bob\'92s technical lead sees that a new .NET patch was installed that day and he records this \'96 one less\
...
\
Bob and his team really don\'92t see how much automation was working in the background, but they know\
they are a step closer to system acceptance because they have a \'93green\'94 vulnerability scan.\
\
